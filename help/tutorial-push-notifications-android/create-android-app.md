...
8. Fare clic su **[!UICONTROL Tools]** > **[!UICONTROL Firebase].** (il progetto verrà aggiunto a [!DNL Firebase])
...
[Verifica che il progetto sia elencato nella console  [!DNL Firebase ]](https://console.firebase.google.com/)
